        ...
        <div className="w-screen max-w-md bg-white shadow-2xl flex flex-col justify-between">
          ...
          <div className="p-4 sm:p-6 bg-slate-900 text-white flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="bg-brand-600 text-white text-xs px-2 py-0.5 rounded-full font-extrabold">
          ...
          <div className="bg-emerald-50 px-4 py-2 text-xs font-semibold text-emerald-900 flex items-center gap-1.5 border-b border-emerald-100">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {cart.length === 0 ? (
              <div className="text-center py-16 px-4">
                ...
                <p className="text-xs text-slate-500 mb-6">Explore our fresh groceries and daily essential deals.</p>
                <button
                  onClick={() => setIsCartOpen(false)}
                  className="bg-brand-600 hover:bg-brand-700 text-white font-bold text-xs px-6 py-3 rounded-full shadow-md"
                >
                  Start Shopping
                </button>
              </div>
              ...
              cart.map((item) => (
                ...
                >
                  {/* Thumbnail */}
                  <div className="relative w-14 h-14 bg-white rounded-xl overflow-hidden shrink-0 border border-slate-100 p-1">
                    <Image
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-slate-500">Rs. {item.product.price} / {item.product.unit}</p>
          ...
          {cart.length > 0 && (
            <div className="p-4 sm:p-6 bg-slate-50 border-t border-slate-200 space-y-4">
              ...
              <div className="space-y-1.5 text-xs text-slate-600">
                ...
                <div className="flex justify-between">
                  <span>Delivery Fee (Shve Ada City)</span>
              ...
              <p className="text-[10px] text-slate-400 text-center flex items-center justify-center gap-1">
                <ShieldCheck className="w-3 h-3 text-emerald-600" /> WhatsApp Direct Order Confirmation & Receipt Engine
              </p>
